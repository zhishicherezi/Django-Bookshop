...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['email', 'username', 'password', 'phone', 'first_name', 'last_name', 'country', 'city', 'index', 'adress1', 'adress2', 'extra', 'token']
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('email', 'username', 'first_name', 'last_name' 'password', 'phone', 'country', 'city',
         'index', 'adress1', 'adress2', 'extra', 'token',)
